/**
 * Job Notification Tracker — Routes and nav only. No data or logic.
 */

(function () {
  var routes = [
    { path: "/", id: "route-home" },
    { path: "/dashboard", id: "route-dashboard" },
    { path: "/settings", id: "route-settings" },
    { path: "/saved", id: "route-saved" },
    { path: "/digest", id: "route-digest" },
    { path: "/proof", id: "route-proof" },
  ];
